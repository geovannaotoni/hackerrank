function formingMagicSquare(s) {
    ...
    let maxValue = Number.MAX_VALUE; //maior valor numerico representavel em JS
    for (let index = 0; index < magicSquares.length; index += 1) {
        ...
        maxValue = Math.min(maxValue, min) //compara maxValue e min e traz o menor valor entre os dois
    }
    return maxValue;
}
